...
FLINK=ifort $(PROJECT) -c -fpic -openmp -O3 -static
WITH_SECOND=1
...
# SOURCE FILE LIST
#
vpath %.f .:..:../Common:../TreeCodes:../BH2dLibraries

FMODS = 

FSRCS = bhfmm2dpart_dr.f bhcommon_oldtree.f\
     bhfmm2dpart.f \
     bhfmm2drouts.f d2tstrcr_omp.f d2mtreeplot.f  \
     l2dterms.f laprouts2d.f  bhrouts.f\
     prini.f \
     hkrand.f dlaran.f
