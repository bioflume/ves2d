...
nInstances = 10;
XstandAll = XoldCoeffs(1:10,1:64);
XnewStandAll = XnewCoeffs(1:10,1:64);
...
nInstances = 10;
XstandAll = [XstandAll;XoldCoeffs(1:10,1:64)];
XnewStandAll = [XnewStandAll;XnewCoeffs(1:10,1:64)];
...
load n256Dt1E4Kb1nModes64PCAData.mat
...
save('n256Only10DtTimesKappasPCAData.mat','nInstances','XoldCoeffs',...
