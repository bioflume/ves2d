function driver_torchRuns(chanWidth,speed,Th)
addpath ../src/
addpath ../examples/
addpath ./shannets/
...
%-------------------------------------------------------------------------
errTol = 1e-2;
maxDt = 5E-6; % dt = 1.28e-3,1e-3, 1.6e-4, 1e-5, 1e-6
...
fileName = ['./output/test_exAdv_diff625kNetJune8_poisRuns_speed' num2str(prams.speed) '_width' num2str(chanWidth) '.bin'];
