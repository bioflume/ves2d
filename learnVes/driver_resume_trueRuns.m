function driver_resume_trueRuns(chanWidth, speed, timeHorizon,dtGiven)
addpath ../src/
...
% VESICLE:
% -------------------------------------------------------------------------
ICfile = ['True_speed' num2str(speed) '_width' num2str(chanWidth) '_FinalIC.mat'];
load(ICfile)
X = Xic;
...
fileName = ['./output/resume_poisTrueRuns_dt' num2str(dt) '_speed' num2str(speed) '_width' num2str(chanWidth) '.bin'];
