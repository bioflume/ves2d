...
for imode = 1 : 32
  zRealStore = zeros(64,nInstances);
  zImagStore = zeros(64,nInstances);
  nLast = 0;
  for ff = 1 : nfiles
    load(['./AdvectNetFFTBasisN32_mode' num2str(imode) '_part' num2str(ff) '_Data.mat'])
  ...
  save(['./completeData/AdvectNetFFTBasisN32_mode' num2str(imode) 'Data.mat'], 'zRealStore','zImagStore','nInstances','-v7.3')
