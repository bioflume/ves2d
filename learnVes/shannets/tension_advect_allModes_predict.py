import torch
from Net_ves_merge_advten import Net_ves_merge_advten # from file import model class
...
model.load_state_dict(torch.load("/Users/gokberk/Documents/GitHub/ves2d/learnVes/shannets/ves_merged_advten.pth",map_location="cpu"))
model.eval()
