...
for iw = 1 : numel(chanWidths)
    ...
    ppDataFile = ['ppTrueData_Speed' num2str(speed) '_width' num2str(chanWidth) '.mat'];
    ...
    ax = gca;
    figName = ['TrueAveVel_speed' num2str(speed) '_width' num2str(chanWidth) '.png'];
    ...
    ax = gca;
    figName = ['TrueVelConfig_speed' num2str(speed) '_width' num2str(chanWidth) '.png'];
    exportgraphics(ax,figName,'Resolution',300)
