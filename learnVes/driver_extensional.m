...
% FLAGS
%-------------------------------------------------------------------------
prams.bgFlow = 'exten'; % 'shear','tayGreen','relax','parabolic'
...
solveType = 'DNN';
fileName = ['./output/extend_ignore_N' num2str(N) '_diff625kNetJune8_dt' num2str(dt) '_speed' num2str(prams.speed) '.bin'];
