function dnnManyVF35RepTest(repStrength, repScale)
addpath ../src/
addpath ../examples/
...
initialVesFile = 'VF35_RepScale2_Str1000'; %'VF35_81VesIC';%'VF30_70VesIC'; % from another run % probVF20IC: fails in 2it
...
fileName = ['./output/repulsion/resume_repStr' num2str(repStrength) '_repScale' num2str(repScale) 'VF35.bin'];
