...
% FLAGS
%-------------------------------------------------------------------------
bgFlow = 'rotation'; % 'shear','tayGreen','relax','parabolic','rotation'
speed = 70 % 500-3000 for shear, 70 for rotation, 100-400 for parabolic 
