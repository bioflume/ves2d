...
prams.dt = 1E-6*2^6; % time step size
...
initialVesFile = 'VF30_70VesIC'; % from another run % probVF20IC: fails in 2it
...
elseif initType == 3
fileName = ['./output/nv' num2str(nv) 'N' num2str(N) ...
    solveType 'TrueNear_Kb1_VF30_bgFlow' bgFlow '_speed' num2str(speed)];
end
