...
prams.volFrac = 0.15; % density of vesicle suspension
prams.RAparticle = 0.95; % reduced area of the particle
...
prams.saveFolder = ['/mnt/ceph/users/gkabacaoglu/SVTGRuns/workspace/denseOptimRuns/resume1_len1_RAp' ...
    num2str(prams.RAparticle*100) '_VFp' num2str(100*prams.volFrac) '_Per' ...
    num2str(prams.period) '/'];
mkdir(prams.saveFolder)
...
prams.Nint = 96; % # of points per an interior wall
prams.Nves = 32;
...
% optimization
prams.wbox = 40; % was 36 based on our initial guess (Dx=Dy=10 and Dpost = 15)
...
prams.Dx = 20; % was 16 initial gap size in horizontal direction
prams.Dy = 20; % was 16 initial gap size in vertical direction
...
% Load the previous best and go on
load bestIter306.mat
points = bpoints;
stdDev = 1.5E-1;
