function [Fvals,Xposts,Dxs,Dys,Dpostxs,Dpostys,nZigZags] = summaryOfIterations(currIter,nParEval,initEvalFlag,iprint,iplot)
...
for k = 1 : numel(checkPoints)
  ...
  nZigZags(localIters) = nZigZagsAll;
end
...
M = [bestIts bestFvals Dposts(bestIts) Dxs(bestIts) Dys(bestIts) nZigZags(bestIts)];
titleStr = 'Iter. #           Fval           Dmax             Dx              Dy          nZZs      \n';
subtitle = '---------      -----------    -----------      --------        --------     --------  \n';
frmt = '%2d,\b\t\t %3.5f,\b\t %1.2f,\t\t %1.2f,\t\t %1.2f, \t\t %2d, \t\t \n';
...
M = [worstIts worstFvals Dposts(worstIts) Dxs(worstIts) Dys(worstIts) nZigZags(worstIts)];
titleStr = 'Iter. #           Fval           Dmax             Dx              Dy          nZZs      \n';
subtitle = '---------      -----------    -----------      --------        --------     --------  \n';
frmt = '%2d,\b\t\t %3.5f,\b\t %1.2f,\t\t %1.2f,\t\t %1.2f, \t\t %2d, \t\t \n';
...
M = [lastIts lastFvals Dposts(lastIts) Dxs(lastIts) Dys(lastIts) nZigZags(lastIts)];
titleStr = 'Iter. #           Fval           Dmax             Dx              Dy          nZZs      \n';
subtitle = '---------      -----------    -----------      --------        --------     --------  \n';
frmt = '%2d,\b\t\t %3.5f,\b\t %1.2f,\t\t %1.2f,\t\t %1.2f, \t\t %2d, \t\t \n';
