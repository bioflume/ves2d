...
Nves = 48;
useFMM = true;
saveFolder = '/work2/03353/gokberk/frontera/denseOptimRuns/testVFp15/';
prams.dtMax = 1e-3;
prams.dtMin = 5e-5;
...
wbox = 40;
DLDscale = 0.05;
Ufar = (80 * 0.05 * 20)/Dy; % (80 is initial velocity, 0.05 DLD scale, 20 is initial Dy)
...
naccept = 0; nreject = 0;
file0 = [fileName '_' num2str(it) '.mat'];
save(file0,'it','Xhist','Xfrozen','XwallsInt','XwallsExt',...
...
while curr_time < prams.Th
  ...
  if rem(it,100) == 0
  file0 = [fileName '_' num2str(it) '.mat'];
  save(file0,'it','Xhist','time','initCys','finalCys','iPartZZ',...
