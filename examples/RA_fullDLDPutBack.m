function RA_fullDLDPutBack(runName,RA,theta,VCs,repulsion,fmm)
...
prams.NbdExt = 3584; % # of points on exterior wall 
...
% Name of log file
options.logFile  = ['./output/reducedAreaRuns/' prams.runName '.log'];
% Name of binary data file for storing vesicle information
options.dataFile = ['./output/reducedAreaRuns/' prams.runName '_Data.bin'];
...
prams.nPutBackMax = ceil(prams.periodN);
