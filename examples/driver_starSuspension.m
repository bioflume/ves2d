...
% [ave_iter,max_iter,trajectories] = starSuspension_Test1stKind(shearStrength, dt, Ns(1));
[ave_iter,max_iter,trajectories] = starSuspension_TestShravan(shearStrength, dt, Ns(1));
