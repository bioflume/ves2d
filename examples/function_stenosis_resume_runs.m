function function_stenosis_resume_runs(runName,VC,Vinf,RA,kappa,tube_length,tube_height,min_height,contraction_width, ICFile)
...
options.logFile = ['/work2/03353/gokberk/frontera/stenosisRuns/' runName 'res2.log'];
% Name of log file for saving messages
options.dataFile = ['/work2/03353/gokberk/frontera/stenosisRuns/' runName '_res2_Data.bin'];
...
runInfoFile = ['/work2/03353/gokberk/frontera/stenosisRuns/' runName '_res2_runInfo.log'];
