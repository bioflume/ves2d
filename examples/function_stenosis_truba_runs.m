function function_stenosis_truba_runs(runName,VC,Vinf,RA,kappa,tube_length,tube_height,min_height,contraction_width)
...
options.logFile = ['/truba_scratch/gkabacaoglu/ves2d/examples/output/stenosisRuns/' runName '.log'];
% Name of log file for saving messages
options.dataFile = ['/truba_scratch/gkabacaoglu/ves2d/examples/output/stenosisRuns/' runName 'Data.bin'];
...
runInfoFile = ['/truba_scratch/gkabacaoglu/ves2d/examples/output/stenosisRuns/' runName '_runInfo.log'];
