...
int gmres(integer *n, doublereal *b, doublereal *x, integer *restrt, doublereal *work, integer *ldw, doublereal *h, 
           integer *ldh, integer *iter, doublereal *resid, int (*matvec) (doublereal*, doublereal*, doublereal*, doublereal*, int, ...),
														   int (*psolve) (doublereal*, doublereal*, int, ...), integer *info)
/*		   
...
/*        AV is temporary workspace here. */
	...
	dcopy_(n, &b[1], &c__1, &work[av * work_dim1 + 1], &c__1);
	(*matvec)(&c_b7, &x[1], &c_b8, &work[av * work_dim1 + 1], 0);
    }
    (*psolve)(&work[r * work_dim1 + 1], &work[av * work_dim1 + 1], 0);
...
L30:
    ...
    (*matvec)(&c_b8, &work[(v + i - 1) * work_dim1 + 1], &c_b20, &work[av * 
	    work_dim1 + 1], 0);
    (*psolve)(&work[w * work_dim1 + 1], &work[av * work_dim1 + 1], 0);
